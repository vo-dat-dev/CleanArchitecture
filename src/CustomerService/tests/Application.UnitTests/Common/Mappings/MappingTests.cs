...
using CustomerService.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using CustomerService.Application.TodoLists.Queries.GetTodos;
using CustomerService.Domain.Entities;
using Microsoft.Extensions.Logging;
using NUnit.Framework;

namespace CustomerService.Application.UnitTests.Common.Mappings;
